...
import { getCourseeHelper, myCourseHelper } from "@/helpers/course/courseApiHelper";
  ...
  return (
    <div className="w-[80%] mx-auto mt-5  ">
      <div className="w-full h-52 ">
          <img src="/cBeadcrumbs.png" className="w-full h-full object-cover" alt="" />
      </div>

      {
        ...
        <div className="right flex-[2] flex justify-center relative mt-[-10%] z-50">
